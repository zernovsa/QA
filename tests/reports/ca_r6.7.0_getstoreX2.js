...
test('test', async () => {
        ...
        for (var i = 0; i < tree2.length; i++) {
            ...
            for (var j = 0; j < tree2[i].childsCount; j++) {
                ...
                //выбираем селектор второй вложенности в зависимости от наличия потомков
                if (childsCount == 0) tree2[i].children.push({
                    id:          j,
                    text:        elText,
                    selector:    Selectors_local.getSubChildItem,
                    childsCount: childsCount
                    ...
                    for (var i2 = 0; i2 < tree2.length; i2++) {
                        ...
                        for (var j2 = 0; j2 < tree2[i2].childsCount; j2++) {
                            ...
                            if (tree2[i2].children[j2].childsCount == 0) {
                                ...
                                if (i2 == 4) {
                                    var sel = Selector(tree2[i2].selector).nth(10 + i2 + 6)
                                }
                                ...
                                for (var z = 0; z < tree2[i2].children[j2].childsCount; z++) {
                                    ...
                                    if (i2 == 3) {
                                        ...
                                        await t.click(sel2)
                                        var s3 = Selector(tree2[i2].children[j2].children[z].selector).nth(tree[i].childsCount +
                                                                                                           z)
                                        await t.click(s3)
                                        await Helper_local.delReport()
                                    }
                        ...
                        for (var i2 = 0; i2 < tree2.length; i2++) {
                            ...
                            for (var j2 = 0; j2 < tree2[i2].childsCount; j2++) {
                                if (tree2[i2].children[j2].childsCount == 0) {
                                    await Helper_local.addReport()
                                    if (i == 2) {
                                        var s1 = Selector(tree[i].selector).nth(i + j + 4)
                                    }
                                    ...
                                    await t.click(sel)
                                    var sel2 = Selector(tree2[i2].children[j2].selector).nth(tree[i].children[j].childsCount +
                                                                                             j2)
                                    await t.click(sel2)
                                    await Helper_local.delReport()
                                }
                                    ...
                                    for (var z2 = 0; z2 < tree2[i2].children[j2].childsCount; z2++) {
                                        ...
                                        await t.click(Selectors_local.add2Report.nth(1))
                                        if (i2 == 3) {
                                            var sel = Selector(tree2[i2].selector).nth(10 + i2 + j2 + 4)
                                        }
                                        else var sel = Selector(tree2[i2].selector).nth(10 + i2 + j2 + 1)
                                        await t.click(sel)
                                        var sel2 = Selector(tree2[i2].children[j2].children[z2].selector).nth(tree[i].children[j].childsCount +
                                                                                                              z2)
                                        await t.click(sel2)
                                        await Helper_local.delReport()
                                    }
