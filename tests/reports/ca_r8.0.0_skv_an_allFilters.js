...
test('ca_r8.0.0_addUserFilters', async () => {
...
// перебрать все фильтры отчета
test('ca_r8.0.0_userFilters', async () => {
...
// перебрать все фильтры отчета
test('ca_r8.0.0_tableColumnsSortrers', async () => {
...
// перебрать все фильтры отчета
test('ca_r8.0.0_checkAll_allFilters', async () => {
...
// перебрать все фильтры отчета
test('ca_r8.0.0_nestingName_allFilters', async () => {
...
test('ca_r8.0.0_indexAll_DD', async () => {
...
// перебрать все фильтры отчета
test('ca_r8.0.0_indexAll_allFilters', async () => {
